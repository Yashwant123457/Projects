...
<h6 class="h6 mt-4 text-uppercase">OVERVIEW OF <?= ($category_details->wedding_type == 0) ? 'No Package Selected' : ucfirst($category_details->wedding_type) . ' PACKAGE'; ?></h6>
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            ...
            <a class="btn btn-sm btn-success mr-2 " style="font-size: 12px;" href="budget.php?<?= $links; ?>"><i class="mdi mdi-currency-inr"></i> Budget</a>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-header">Amount Paid To Date</div>
                    <div class="card-body">
                        <h5 class="card-title">Rs <?= number_format($cash,2); ?></h5>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Rs <?= number_format($account_details->cash_advanced, 2); ?></h5>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Rs <?= @number_format($category_details->price - $account_details->cash_advanced, 2); ?></h5>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
