...
<table id="example" class="table table-striped table-hover table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <tbody>
        <tr>
            ...
            <?= ($category_details->wedding_type != 0) ? ucfirst($category_details->wedding_type) . " Package Wedding" : 'No Package Selected'; ?>

            </td>
            <td class="special-budget">
                Rs <?= @number_format($category_details->price, 2); ?>
            </td>
            <td class="special-budget">
                Rs <?= @number_format($account_details->cash_advanced,2); ?>
            </td>
            <td class="special-budget">
                Rs <?= @number_format($cash,2); ?>
            </td>
            <td class="special-budget">
                Rs <?= @number_format($category_details->price - $account_details->cash_advanced, 2); ?>
            </td>
            <td>
